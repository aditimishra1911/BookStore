...
const Navbar = ({ onSearch }) => {
    ...
    return (
        <>
            <div className={`bg-white dark:bg-slate-900 shadow ${sticky ? 'sticky-navbar' : ''}`}>
                <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 shadow-md
